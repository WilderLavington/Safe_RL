...
class GRID_WORLD_1_POLICY(torch.nn.Module):
    """
    ...
    def __init__(self, state_size, action_size, actions, hidden_layer_size):
        super(GRID_WORLD_1_POLICY, self).__init__()
        ...
        # layer info
        self.linear = torch.nn.Linear(state_size, actions)
        # output
    ...
    def sample_action(self, state):
        ...
        probabilities = self.linear(input)
